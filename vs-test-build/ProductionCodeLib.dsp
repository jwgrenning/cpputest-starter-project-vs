...
# ADD CPP /nologo /MDd /W3 /GX /ZI /Od /I "../include/util" /I "$(CPPUTEST_HOME)/include" /I "$(CPPUTEST_HOME)/include/Platforms/VisualCpp" /FI"$(CPPUTEST_HOME)\include\CppUTest\MemoryLeakDetectorMallocMacros.h" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /FD /GZ /c
...
SOURCE="$(InputPath)"
PostBuild_Cmds=copy Debug\ProductionCodeLib.lib ..\lib\ProductionCodeLib.lib
...
SOURCE=..\SomeDirectory\example.c
# End Source File
# End Group
